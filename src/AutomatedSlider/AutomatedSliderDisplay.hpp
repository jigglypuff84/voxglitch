struct AutomatedSliderDisplay : OpaqueWidget
{
  AutomatedSlider *module;
  bool dragging = false;

  AutomatedSliderDisplay(AutomatedSlider *module): OpaqueWidget()
  {
    this->module = module;
  ...
  void draw(const DrawArgs &args) override
  {
    ...
    if(module)
    {
      ...
      */
      ...
      nvgFillColor(vg, nvgRGB(223,234,251));
      nvgFill(vg);
      // nvgStroke(vg);
